              ...
              child: Column(
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      Text("Due Payment", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),),
                      Text("\₹360", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),),
                    ],
                  ),
                  SizedBox(height: 10,),
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      Text("\₹360", style: TextStyle(fontSize: 20, fontWeight: FontWeight.normal),),
                    ],
                  ),
                ],
              ),
